...
- `osca lint`——账本纪律的机器化：25 条规则，覆盖包结构、ID 与引用、账本纪律（出生证据 / supersedes 链 / trust 计数 / 回放断言）、零密钥铁律。规则清单见 [docs/OSCA-LINT-RULES.md](../docs/OSCA-LINT-RULES.md)
...
# ✓ 通过 · 0 错误, 0 警告 · 检查 YAML 16 个 · 规则 25 条
