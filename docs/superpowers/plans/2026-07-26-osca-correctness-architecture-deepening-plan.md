...
- [x] **Step 3: Implement immutable capture**
...
- [x] **Step 4: Move lint rules to snapshot queries**
...
- [x] **Step 5: Add `lint_snapshot` and stable error adaptation**
...
- [x] **Step 6: Run focused CLI tests and confirm GREEN**
...
- [x] **Step 1: Add the lint-to-archive race regression**
...
- [x] **Step 3: Replace pack rereads with snapshot bytes**
...
- [x] **Step 4: Run pack/load tests and confirm GREEN**
...
- [x] **Step 1: Add directory and zip handoff regressions**
...
- [x] **Step 3: Add an internal snapshot-returning load path**
...
- [x] **Step 4: Parse Host structures from the returned snapshot**
...
- [x] **Step 5: Pin the package generation during Episode assembly**
...
- [x] **Step 6: Replace `_pack_stamp` disk hashing**
...
- [x] **Step 7: Add fingerprint and G1/G2 persistence tests**
...
- [x] **Step 8: Migrate ledger refresh to the snapshot generation**
...
- [x] **Step 9: Run CLI and Host load/suspension tests**
...
- [x] **Step 1: Add lifecycle cleanup failures**
...
- [x] **Step 3: Implement lifecycle Module**
...
- [x] **Step 4: Route Runner and Host terminal paths through the Module**
...
- [x] **Step 5: Run runner/control tests and confirm GREEN**
...
- [x] **Step 1: Add the retention regression**
...
- [x] **Step 3: Cap the list and emit the structured record**
...
- [x] **Step 1: Add dispatch isolation failures**
...
- [x] **Step 3: Implement per-subscription lanes**
...
- [x] **Step 4: Clean lanes on unsubscribe and shutdown**
...
- [x] **Step 5: Run trigger and control tests**
...
- [x] **Step 1: Add the bool-day regression**
...
- [x] **Step 3: Require exact integer semantics**

Use `type(day) is int and 1 <= day <= 31`, preserving all other parser behavior.

- [x] **Step 4: Correct documentation**
...
- [x] **Step 1: Run all CLI tests**

Run: `cd cli && uv run pytest -q`

Expected: all tests pass.

- [x] **Step 2: Run all Host tests**
...
- [x] **Step 4: Lint official sample packages**
...
- [x] **Step 5: Refresh Host lock against local CLI**
...
- [x] **Step 7: Commit any verification-only lock update**
