...
📘 **ホワイトペーパー：** [English](docs/OSCA-WHITEPAPER-v1.0.en.md) ·
[简体中文](docs/OSCA-WHITEPAPER-v1.0.zh-CN.md) · [日本語](docs/OSCA-WHITEPAPER-v1.0.ja.md) —
設計思想、O/S/C/A/J、Runtime、フィードバック・フライホイール、自分の OSCA Agent を
実装し始める方法を説明する。ホワイトペーパー v1.0 はソフトウェア 1.0 のリリースではない。
...
├── docs/OSCA-WHITEPAPER-v1.0.zh-CN.md # Open-spec whitepaper: 简体中文
├── docs/OSCA-WHITEPAPER-v1.0.ja.md    # Open-spec whitepaper: 日本語
...
- **Software 1.0 Gate：** 実 Content Evidence、製品 UI、Creator、本番統合を完了し、仕様、
  参照実装、Replay 可能な管理された実 Sample Ledger を提供する。顧客 Raw Ledger の公開は不要。
