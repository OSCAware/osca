...
[中文 PDF ダウンロード](docs/OSCA-WHITEPAPER-v1.1.zh-CN.pdf) —
設計思想、O/S/C/A/J、Runtime、フィードバック・フライホイール、自分の OSCA Agent を
実装し始める方法を説明する。ホワイトペーパー v1.1 は文書版であり、ソフトウェア 1.0 のリリースではない。
...
├── docs/OSCA-WHITEPAPER-v1.1.zh-CN.pdf # 中文ホワイトペーパー PDF
